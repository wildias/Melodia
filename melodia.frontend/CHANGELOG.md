...
- Crie um projeto react com create-vite: `npm init --yes vite@latest melodia.frontend -- --template=react-ts`.
- Atualizando `vite.config.ts`com a porta.
- Criar o arquivo de projeto (`melodia.frontend.esproj`).
